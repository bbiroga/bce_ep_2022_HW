...
def creating_figure_three(nodes, G):
    """This function merges the three preliminary functions, making it possible to plot the three charts for Figure 3 together
    For each chart, it manipulates the data creating the plot_inputs dataframes, then creates the charts
    """
    # (a) Degree Centrality
...
def creating_figure_five(edges_w_features):
    """This functions merges 4 preliminary functions to create the inputs and plot the heatmaps for Figure 5"""
